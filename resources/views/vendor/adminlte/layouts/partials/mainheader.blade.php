            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @if(count($notifications)>0)<span
                            class="label label-warning">{{$notifications->count()}}</span>@endif
                    </a>
                    <ul class="dropdown-menu">
                        <li class="header">@if(count($notifications)>0) You have {{$notifications->count()}}
                            notifications @endif</li>
                        <li>
