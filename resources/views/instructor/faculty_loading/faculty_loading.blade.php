...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Faculty Workloads</li>
    </ol>
</section>
                ...
                <div class="box-body no-padding">
                    <table class="table table-borderless table-condensed">
                        ...
                        <tr style="background:lightsalmon; margin: 0; padding:0px">
                            <td align="center"><label style="margin:0;" class="callout callout-danger">Schedule w/ red
                                    color indicates that the coordinator suggests you this load.</label></td>
                        </tr>
                        <tr style="background:lightblue;">
                            <td align="center"><label style="margin:0;" class="callout callout-info">Schedule w/ blue
                                    color indicates that this event is your current load.</label></td>
                        </tr>
                    </table>
                </div>
            </div>
                                ...
                                <tr style="background:lightblue;">
                                    ...
                                    <td>
                                        <div align="center">
                                            ...
                                            {{date('g:iA', strtotime($schedule2->time_starts))}}-{{date('g:iA', strtotime($schedule2->time_end))}}]<br>
                                            @endforeach
                                        </div>
                                    </td>
                                </tr>
    ...
    if (reason == "") {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                toastr.warning('You have notified the coordinator why you reject the schedule.',
                    'Notification!');
            },
            error: function() {
...
function accept_load(offering_id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            reloadtabular();
            $('#calendar').fullCalendar('refetchEvents')
            toastr.info('You have notified the coordinator that you accepted the schedule',
                'Notification!');
        },
        error: function() {
            toastr.error('Something Went Wrong!', 'Message!');
