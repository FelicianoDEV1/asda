            ...
            <div class="box box-solid box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$schedule->day}}
                                        {{date('g:iA',strtotime($schedule->time_starts))}}-{{date('g:iA',strtotime($schedule->time_end))}}
                                    </td>
                                    <td><a href="{{url('/admin/course_scheduling/attach_schedule',array($schedule->id,$offering_id))}}"
                                            class="btn btn-flat btn-block btn-success"><i
                                                class="fa fa-plus-circle"></i></a></td>
                                    <td><a href="{{url('/admin/course_scheduling/delete_schedule',array($schedule->id,$offering_id))}}"
                                            onclick="return confirm('Do you wish to continue?')"
                                            class="btn btn-flat btn-block btn-danger"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="callout callout-warning">
                        <div align="center">
                            <h5>No Inactive Schedule Available!</h5>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <label>Add</label>
                            <a onclick="addschedule(day.value,time_start.value,time_end.value)"
                                class="btn btn-flat btn-success"><i class="fa fa-plus-circle"></i></a>
                        </div>
                    </div>
                </div>
...
$('#calendar').fullCalendar({
    ...
    eventClick: function(event) {
        var boolean = confirm(
            'Clicking the OK button button will change the status of the schedule. Do you wish to continue?'
        );
        if (boolean == true) {
            window.open('/admin/course_scheduling/remove_schedule/' + event.id + '/' + event.offering_id,
                '_self');
        }
    }
});
