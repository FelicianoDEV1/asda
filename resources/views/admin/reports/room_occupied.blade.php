...
<div class="container-fluid" style="margin-top: 15px;">
    <div class="box box-default">
        <div class="box-header">
            <h5 class="box-title">Search Filters</h5>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-sm-8">
                    <div class="form-group">
                        <label>Rooms</label>
                        <select class="form-control select1" id="room">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>&nbsp</label>
                        <button onclick="searchdata(room.value)" class="btn-block btn btn-flat btn-primary"><i
