    ...
    <div class="container-fluid">
        <div class="box box-default">
            <div class="box-header">
                <h5 class="box-title">List of Instructors</h5>
            </div>
            <div class="box-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('/admin/instructor/edit_faculty_loading',array($instructor->id))}}"
                                        class="btn btn-flat btn-success"><i class="fa fa-calendar-check-o"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
