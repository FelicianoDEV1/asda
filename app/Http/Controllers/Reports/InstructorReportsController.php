...
class InstructorReportsController extends Controller
{
    ...
    function view_add() {
        $userAccessLevel = Auth::user()->accesslevel;
    
        // Update the condition to include both 0 (admin) and 100 (superadmin) access levels
        if ($userAccessLevel == 0 || $userAccessLevel == 100) {
